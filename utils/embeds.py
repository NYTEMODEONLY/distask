...
class EmbedFactory:
    def __init__(self, color: discord.Color = discord.Color.blurple()) -> None:
        self.color = color
    ...
    def board_detail(
        ...
        embed.set_footer(text=f"Channel ID: {board['channel_id']}")
        return embed
    ...
    def task_detail(
        ...
        embed.set_footer(text=f"Board ID: {task['board_id']}")
        return embed
